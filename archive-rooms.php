    ...
    <?php if ( have_posts() ) : ?>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            <?php while ( have_posts() ) : the_post(); ?>
                <?php
                // Get custom fields for dynamic data (to be implemented later with core plugin)
                $original_price = 150; // Placeholder for discounted_from
                $actual_price = 100; // Placeholder for actual_amount
                ?>
                <div class="col">
