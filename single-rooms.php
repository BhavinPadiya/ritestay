                        ...
                        <?php if ($image1 || $image2 || $image3) : ?>
                            <div id="roomCarousel" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <?php
                                    // Specify a larger image size for the single room page
                                    $image_size = 'room-carousel-thumb';
                                    ?>
                                    <?php if ($image1) : ?>
                                        <div class="carousel-item active">
                                            <img src="<?php echo esc_url($image1['sizes'][$image_size]); ?>" class="d-block w-100" alt="<?php echo esc_attr($image1['alt']); ?>">
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($image2) : ?>
                                        <div class="carousel-item">
                                            <img src="<?php echo esc_url($image2['sizes'][$image_size]); ?>" class="d-block w-100" alt="<?php echo esc_attr($image2['alt']); ?>">
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($image3) : ?>
                                        <div class="carousel-item">
                                            <img src="<?php echo esc_url($image3['sizes'][$image_size]); ?>" class="d-block w-100" alt="<?php echo esc_attr($image3['alt']); ?>">
                                        </div>
                                    <?php endif; ?>
                                </div>
